...
<p align="center">
  <img src="docs/assets/omnimux-preview.png" alt="OmniMux 客户端界面预览 - 属于你的 AI 社媒运营团队" width="100%">
</p>
...
**OmniMux** 是专为跨境电商、短视频创作者、MCN 机构与出海营销团队打造的**开源企业级社媒营销Agent**（基于 [DeepSeek Harness (DSH)](https://github.com/deepseek-ai/deepseek-harness) 运行时）。
...
| :--- | :--- | :--- | :--- | :--- |
| **核心业务定位** | **企业级社媒营销Agent** | 跨境电商商品链接转广告视频 (URL to Video) | 社媒短视频爆款脚本复刻与批量裂变 | 固定模板换字换图拼装 |
