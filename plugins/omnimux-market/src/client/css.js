...
.hover-btn-label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
@container market-featured-card (max-width:208px){.featured-hover-actions{justify-content:center}.hover-btn-label{display:none}.hover-btn{flex:0 0 auto;width:34px;padding:0}}
