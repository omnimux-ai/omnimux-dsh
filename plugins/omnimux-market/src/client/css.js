...
.nav-bar{display:flex;flex-wrap:nowrap;align-items:center;justify-content:space-between;margin-bottom:18px;gap:16px;min-width:0;border-bottom:1px solid var(--dsw-alias-border-l2);padding-bottom:2px}
