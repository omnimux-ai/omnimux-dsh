...
export function plazaDiscoverySections(items = [], { category = '', query = '', uninstalledOnly = false, installedItems = [], config = recommendations, entries = catalog.items, presetBinding = null } = {}) {
