...
const POCKET_MASK = `url("data:image/svg+xml,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 516 378" preserveAspectRatio="none"><path fill="white" d="${POCKET_PATH}"/></svg>`)}")`
