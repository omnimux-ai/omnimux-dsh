...
.omnimux-folder[data-cover-kind=empty] .omnimux-folder-pocket { fill: color-mix(in srgb, var(--dsw-alias-bg-elevated) 91%, var(--dsw-alias-brand-primary)); }
...
.omnimux-folder-pocket { position: absolute; inset: 0; width: 100%; height: 100%; fill: var(--dsw-alias-bg-elevated); stroke: var(--dsw-alias-border-l2); stroke-width: 1.5; }
...
.omnimux-folder-menu { position: absolute; z-index: 4; bottom: 20%; right: 5%; padding: 4px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 10px; background: var(--dsw-alias-bg-elevated); box-shadow: 0 4px 16px var(--dsw-alias-bg-mask-1); }
...
.omnimux-cover-status { position: absolute; top: 7%; right: 6%; font-size: 12px; line-height: 20px; min-width: 20px; text-align: center; border-radius: 50%; background: var(--dsw-alias-bg-elevated); color: var(--dsw-alias-label-secondary); }
...
.omnimux-cover-content--empty { background: color-mix(in srgb, var(--dsw-alias-bg-elevated) 90%, var(--dsw-alias-brand-primary)); }
`
