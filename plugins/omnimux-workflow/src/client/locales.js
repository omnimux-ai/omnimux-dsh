export const zh = {
  ...
  'stage.title': '工作流',
  'stage.close': '关闭',
  'workflow.pageTitle': 'ComfyUI 工作流',
  'workflow.pageSubtitle': '支持本地部署，可手动运行，也可由 Agent 调用',
  'workflow.action.new': '导入/新建工作流',
  'workflow.action.explore': '📖 探索开源',
  'workflow.tab.featured': '精选工作流',
  'workflow.tab.my': '我的工作流',
...
export const en = {
  ...
  'stage.close': 'Close',
  'workflow.pageTitle': 'ComfyUI Workflow',
  'workflow.pageSubtitle': 'Supports local deployment, manual execution, and Agent invocation',
  'workflow.action.new': 'Import / New Workflow',
  'workflow.action.explore': '📖 Explore Open Source',
  'workflow.tab.featured': 'Featured Workflows',
  'workflow.tab.my': 'My Workflows',
