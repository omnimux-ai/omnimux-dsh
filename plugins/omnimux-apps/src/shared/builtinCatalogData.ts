...
export const BUILTIN_MANIFESTS = Object.freeze([
  ...
  },
  {
    ...
    "version": "1.0.0",
    "workflowBinding": {
      "workspaceId": "ws-app-builtin-product-video",
      "workflowVersion": 1
    },
    "metadata": {
      "name": "商品生视频",
      "category": "video",
      "description": "粘贴商品链接或选择商品主图，一键生成带货短视频",
      "icon": "video",
      "tags": [
        "builtin",
        "e-commerce",
    ...
    "formSchema": {
      ...
      "properties": {
        ...
        "custom_brief": {
          "type": "string",
          "title": "自定义描述",
          "description": "自定义视频内容下生效，描述想要的视频内容与风格",
          "widget": "textarea",
          "maxLength": 300,
          "placeholder": "请输入视频内容与风格..."
        },
        "platforms": {
          "type": "array",
          "title": "投放平台",
          "description": "选择本次成片要适配的平台，最多 3 个",
          "widget": "multi-tags",
          "items": {
            "type": "string"
          },
    ...
    "fieldMappings": {
      ...
      "content_mode": {
        "nodeId": "node-video-generation-core",
        "targetField": "params.contentMode",
        "mappingType": "param",
        "widget": "segmented-tabs",
        "required": false,
        "defaultValue": "preset"
  ...
  {
    "schemaVersion": "1.0.0",
    "appId": "app-builtin-viral-replication",
    "version": "1.0.0",
    "workflowBinding": {
      "workspaceId": "ws-app-builtin-viral-replication",
      "workflowVersion": 1
    },
    "metadata": {
      "name": "爆款复刻",
      "category": "video",
      "description": "以爆款参考视频为蓝本，按你的改写意图复刻同款结构与节奏",
      "icon": "video",
      "tags": [
        "builtin",
        "viral-video",
    ...
    "formSchema": {
      ...
      "properties": {
        "reference_video": {
          "type": "string",
          "title": "参考视频",
          "description": "粘贴链接或上传，自动解析。支持 TikTok",
          "widget": "media-extractor",
          "placeholder": "粘贴视频链接或上传，自动解析"
        },
        "reference_inspiration": {
          "type": "string",
          "title": "参考灵感",
          "description": "从灵感库选一条爆款作为参考",
          "widget": "library-picker",
          "library": "inspiration",
          "placeholder": "从灵感库选择"
        },
    ...
    "fieldMappings": {
      "reference_video": {
        "nodeId": "node-slot-reference-video",
        "targetField": "mediaUrl",
        "mappingType": "media",
        "widget": "media-extractor",
        "required": true
      ...
      "reference_inspiration": {
        "nodeId": "node-slot-reference-inspiration",
        "targetField": "mediaUrl",
        "mappingType": "media",
        "widget": "library-picker",
        "required": false
      ...
      "rewrite_intent": {
        "nodeId": "node-slot-rewrite-intent",
        "targetField": "content",
        "mappingType": "text",
        "widget": "textarea",
        "required": true
  ...
  {
    "schemaVersion": "1.0.0",
    "appId": "app-builtin-video-to-prompt",
    "version": "1.0.0",
    "workflowBinding": {
      "workspaceId": "ws-app-builtin-video-to-prompt",
      "workflowVersion": 1
    },
    "metadata": {
      "name": "视频转提示词",
      "category": "video",
      "description": "拆解参考视频的钩子、节奏与分镜，反推可复用的生成提示词",
      "icon": "video",
      "tags": [
        "builtin",
        "deconstruction",
    ...
    "fieldMappings": {
      ...
      "analysis_focus": {
        "nodeId": "node-prompt-analysis-core",
        "targetField": "params.analysisFocus",
        "mappingType": "param",
        "widget": "multi-tags",
        "required": false,
        "defaultValue": [
      ...
      "prompt_language": {
        "nodeId": "node-prompt-analysis-core",
        "targetField": "params.promptLanguage",
        "mappingType": "param",
        "widget": "segmented-tabs",
        "required": false,
        "defaultValue": "zh"
