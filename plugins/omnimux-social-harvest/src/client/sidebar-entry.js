export const ENTRY_SELECTOR = '[data-omnimux-social-harvest-entry]'
export const HARVEST_TAB_ID = 'omnimux-social-harvest:library'

const ICON = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4.5"/><circle cx="12" cy="12" r="1.4" fill="currentColor"/></svg>'
...
export function mountSidebarEntry(_stage, t, locale) {
  return createSidebarEntry({
    ...
    rank: 3.8,
    label: () => (typeof t === 'function' ? t('nav') : '社媒采集'),
    iconSvg: ICON,
    stageStore: createWorkbenchStageStore(t, HARVEST_TAB_ID),
    locale,
    access: 'offline',
    customClassName: 'omnimux-social-harvest-entry',
    datasetKey: 'data-omnimux-social-harvest-entry',
  })
}
