...
export const guideZh = {
  ...
  "trending.sample.badge": "示例数据",
  "trending.sample.hint": "接入灵感库前，这里展示的是示例样本，不是实时榜单。",
...
export const guideEn = {
  ...
  "trending.sample.badge": "Sample data",
  "trending.sample.hint": "Until the inspiration library is wired in, these cards are samples, not a live ranking.",
