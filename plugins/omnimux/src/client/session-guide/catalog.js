...
export const guideZh = {
  ...
  "trending.subtitle": "基于实时跑量数据筛出值得复刻的爆款结构，一键接管输入框直接出片。",
  "trending.filters.label": "爆款筛选条件",
  "trending.filter.region": "地区",
  "trending.filter.industry": "行业",
  "trending.filter.views": "播放量",
  "trending.filter.revenue": "预估营收",
  "trending.filter.engagement": "互动率",
  "trending.filter.roas": "ROAS",
  "trending.filter.range": "统计时间窗",
  "trending.filter.sort": "排序方式",
  "trending.filter.reset": "重置筛选",
  "trending.filter.count": "命中 {count} 条",
  "trending.region.all": "全部地区",
  "trending.industry.all": "全部行业",
  "trending.industry.apparel": "服饰穿搭",
  "trending.industry.home": "家居日用",
  "trending.industry.beauty": "美妆个护",
  "trending.industry.digital": "数码科技",
  "trending.industry.outdoor": "户外运动",
  "trending.industry.kitchen": "厨房餐厨",
  "trending.views.all": "不限播放量",
  "trending.views.100k": "播放 100K+",
  "trending.views.1m": "播放 1M+",
  "trending.views.5m": "播放 5M+",
  "trending.views.10m": "播放 10M+",
  "trending.revenue.all": "不限营收",
  "trending.revenue.100k": "营收 $100K+",
  "trending.revenue.1m": "营收 $1M+",
  "trending.revenue.10m": "营收 $10M+",
  "trending.engagement.all": "不限互动率",
  "trending.engagement.4": "互动率 4%+",
  "trending.engagement.6": "互动率 6%+",
  "trending.engagement.8": "互动率 8%+",
  "trending.roas.all": "不限 ROAS",
  "trending.roas.2": "ROAS 2x+",
  "trending.roas.4": "ROAS 4x+",
  "trending.roas.6": "ROAS 6x+",
  "trending.range.d7": "近 7 天",
  "trending.range.d30": "近 30 天",
  "trending.range.d90": "近 90 天",
  "trending.sort.views": "排序：播放量",
  "trending.sort.revenue": "排序：预估营收",
  "trending.sort.engagement": "排序：互动率",
  "trending.sort.roas": "排序：ROAS",
  "trending.info.revenue": "按投放数据推算的单条视频预估带货营收。",
  "trending.info.engagement": "互动总量与播放量之比。",
  "trending.info.roas": "广告支出回报倍数，>3 视为可放量。",
  "trending.metric.revenue": "预估营收",
  "trending.metric.views": "播放量",
  "trending.card.recreate": "复刻",
  "trending.empty": "当前筛选条件下没有匹配的爆款样本。",
  "trending.applied": "已把复刻指令填入会话输入框，可直接发送",
  "trending.dock.title": "复刻这条爆款视频",
  "trending.dock.placeholder": "描述你希望替换进去的内容…",
  "trending.dock.attach": "添加素材",
  "trending.dock.expert": "启用专家",
  "trending.dock.cancel": "取消复刻",
  "trending.dock.submit": "发送复刻指令",
}
...
export const guideEn = {
  ...
  "trending.subtitle": "Filter live ad performance to surface structures worth cloning, then hand straight over to the composer.",
  "trending.filters.label": "Trending filters",
  "trending.filter.region": "Region",
  "trending.filter.industry": "Industry",
  "trending.filter.views": "Video views",
  "trending.filter.revenue": "Estimated revenue",
  "trending.filter.engagement": "Engagement",
  "trending.filter.roas": "ROAS",
  "trending.filter.range": "Date range",
  "trending.filter.sort": "Sort",
  "trending.filter.reset": "Reset filters",
  "trending.filter.count": "{count} results",
  "trending.region.all": "All regions",
  "trending.industry.all": "All industries",
  "trending.industry.apparel": "Apparel",
  "trending.industry.home": "Home & Living",
  "trending.industry.beauty": "Beauty & Care",
  "trending.industry.digital": "Digital & Tech",
  "trending.industry.outdoor": "Outdoor & Sport",
  "trending.industry.kitchen": "Kitchen & Dining",
  ...
  "trending.revenue.all": "Estimated revenue",
  "trending.revenue.100k": "$100K+ revenue",
  "trending.revenue.1m": "$1M+ revenue",
  "trending.revenue.10m": "$10M+ revenue",
  "trending.engagement.all": "Engagement",
  "trending.engagement.4": "4%+ engagement",
  "trending.engagement.6": "6%+ engagement",
  "trending.engagement.8": "8%+ engagement",
  "trending.roas.all": "ROAS",
  "trending.roas.2": "2x+ ROAS",
  "trending.roas.4": "4x+ ROAS",
  "trending.roas.6": "6x+ ROAS",
  "trending.range.d7": "Last 7 days",
  "trending.range.d30": "Last 30 days",
  "trending.range.d90": "Last 90 days",
  "trending.sort.views": "Sort: Video views",
  "trending.sort.revenue": "Sort: Estimated revenue",
  "trending.sort.engagement": "Sort: Engagement",
  "trending.sort.roas": "Sort: ROAS",
  "trending.info.revenue": "Modeled per-video product revenue inferred from ad delivery data.",
  "trending.info.engagement": "Total interactions divided by video views.",
  "trending.info.roas": "Return on ad spend; above 3x is generally scalable.",
  "trending.metric.revenue": "Revenue",
  "trending.metric.views": "Views",
  "trending.card.recreate": "Recreate",
  "trending.empty": "No trending sample matches the current filters.",
  "trending.applied": "Clone brief prefilled in the conversation composer — send when ready",
  "trending.dock.title": "Recreate this viral ad",
  "trending.dock.placeholder": "Describe what should replace the original content…",
  "trending.dock.attach": "Add asset",
  "trending.dock.expert": "Activate expert",
  "trending.dock.cancel": "Cancel recreate",
  "trending.dock.submit": "Send clone brief",
}
