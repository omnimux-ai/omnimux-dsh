export const zh = {
  ...
  'quickShortcuts.link.videoEntry': '视频链接',
  'quickShortcuts.link.productEntry': '商品链接',
  ...
  'quickShortcuts.notice.promptUnconfirmed': '无法确认草稿状态，原内容已保留。请编辑正文后重试。',
  'attachments.popover.videoTitle': '添加视频链接',
  'attachments.popover.productTitle': '添加商品链接',
  'attachments.popover.videoPlaceholder': '粘贴视频链接',
  'attachments.popover.productPlaceholder': '粘贴商品页面链接',
  'attachments.popover.videoHint': '添加参考视频，用于拆解或复刻。',
  'attachments.popover.productHint': '添加商品页面，用于介绍产品或制作带货视频。',
  'attachments.popover.invalidUrl': '请粘贴一个完整的 http 或 https 链接',
  'attachments.popover.addFailed': '未能添加链接，请重试',
  'attachments.popover.close': '关闭',
  'attachments.popover.add': '添加',
  ...
  'runtime.mediaModelsToggle': '媒体模型映射配置',
  'runtime.expand': '展开配置',
  'runtime.collapse': '收起配置',
  ...
  'attachments.submit.prepare.waiting': '正在确认草稿更新，请稍后再次发送。',
  'attachments.submit.prepare.ready': '内容已补齐，请再次发送。',
  'attachments.submit.prepare.changed': '草稿已变化，链接和创意设置已保留，请检查后再次发送。',
  'attachments.submit.prepare.unavailable': '无法安全补齐草稿，链接和创意设置已保留，请重试。',
  'attachments.submit.prepare.unconfirmed': '草稿更新尚未确认，链接和创意设置已保留。请编辑草稿后再次发送以重新检查。',
  'attachments.submit.prepare.legacyUnconfirmed': '草稿更新尚未确认，原内容已保留。当前编辑器无法安全重试，请勿重复添加。',
...
export const en = {
  ...
  'quickShortcuts.link.videoEntry': 'Video link',
  'quickShortcuts.link.productEntry': 'Product link',
  ...
  'quickShortcuts.notice.promptUnconfirmed': 'The draft state could not be confirmed. Your content was kept. Edit the message, then try again.',
  'attachments.popover.videoTitle': 'Add video link',
  'attachments.popover.productTitle': 'Add product link',
  'attachments.popover.videoPlaceholder': 'Paste video link',
  'attachments.popover.productPlaceholder': 'Paste product page link',
  'attachments.popover.videoHint': 'Add reference video for breakdown or replication.',
  'attachments.popover.productHint': 'Add product page to introduce product or create selling video.',
  'attachments.popover.invalidUrl': 'Please paste a complete http or https link',
  'attachments.popover.addFailed': 'Could not add link, please retry',
  'attachments.popover.close': 'Close',
  'attachments.popover.add': 'Add',
  ...
  'models.title': 'Creative Canvas Models',
  'models.description': 'Configure default models and parameter rules for new canvas nodes on the workbench panel',
  ...
  'runtime.cardTitle': 'Conversation & Media Generation Models',
  'runtime.cardDesc': 'Configure local CLI assistants for conversation prompts and media generation providers for images, videos, and audio',
  'runtime.title': 'Runtime',
  'runtime.hint': 'Who generates text and media; accounts, publish and quota still need sign-in',
  'runtime.tabCli': 'Local CLI',
  'runtime.tabMedia': 'Media Generation Providers',
  'runtime.cloudTitle': 'Use OmniMux Cloud',
  'runtime.cloudHint': 'Sign in to cloud version to enable team spaces, shared projects, cloud assets and collaboration.',
  'runtime.cloudLoggedTitle': 'OmniMux Cloud connected',
  'runtime.cloudLoggedHint': 'Team workspace and project collaboration enabled.',
  'runtime.loginOrRegister': 'Sign In / Register',
  'runtime.logout': 'Sign Out',
  'runtime.cliHeader': 'Select the CLI used to run prompts.',
  'runtime.cliCount': 'Your CLI ({count})',
  'runtime.mediaProviderHeader': 'Choose a media generation provider to configure image, video, and audio generation models.',
  'runtime.recommended': 'Recommended',
  'runtime.currentChat': 'Current conversation link: ',
  'runtime.currentMedia': 'Media link: ',
  'runtime.defaultChat': 'DSH native / default',
  'runtime.mediaReady': '✓ Media provider ready',
  'runtime.unconfigured': 'Unconfigured',
  'runtime.modelLabel': 'Model',
  'runtime.cliDefaultSetting': 'CLI default settings',
  'runtime.imageModel': 'Image Model',
  'runtime.videoModel': 'Video Model',
  'runtime.audioModel': 'Audio Model',
  'runtime.endpointLabel': 'API Endpoint (Base URL)',
  ...
  'runtime.mediaModelsToggle': 'Media Model Mapping',
  'runtime.expand': 'Expand',
  'runtime.collapse': 'Collapse',
  ...
  'attachments.submit.prepare.waiting': 'Waiting for the draft update. Please send again shortly.',
  'attachments.submit.prepare.ready': 'Content is ready. Please send again.',
  'attachments.submit.prepare.changed': 'The draft changed. Links and creative settings were kept. Review it and send again.',
  'attachments.submit.prepare.unavailable': 'The draft could not be updated safely. Links and creative settings were kept. Please retry.',
  'attachments.submit.prepare.unconfirmed': 'The draft update is unconfirmed. Links and creative settings were kept. Edit the draft, then send again to recheck.',
  'attachments.submit.prepare.legacyUnconfirmed': 'The draft update is unconfirmed and the original content was kept. This editor cannot safely retry; do not add it again.',
