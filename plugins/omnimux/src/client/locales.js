export const zh = {
  ...
  'composerAdd.pathLabel': '文件或文件夹路径',
  'composerAdd.pathPlaceholder': '/Users/name/Documents/文件.txt\n/Users/name/Documents/素材文件夹',
  'composerAdd.pathHelp': '输入运行 OmniMux 的电脑上的绝对路径，每行一项。文件夹保留目录结构，原文件不会移动或删除。',
  'composerAdd.pathInvalid': '请输入完整的本机绝对路径，不支持相对路径或路径变量。',
  'composerAdd.importing': '正在添加…',
...
export const en = {
  ...
  'composerAdd.pathLabel': 'File or folder paths',
  'composerAdd.pathPlaceholder': '/Users/name/Documents/file.txt\n/Users/name/Documents/assets',
  'composerAdd.pathHelp': 'Enter absolute paths on the computer running OmniMux, one per line. Folder structure is preserved. Original files are not moved or deleted.',
  'composerAdd.pathInvalid': 'Enter full absolute paths. Relative paths and path variables are not supported.',
  'composerAdd.importing': 'Adding…',
