...
const EN: PanelCopy = {
  ...
  settings: {
    ...
    tokenHelp: 'Pairing token required by every instance, local included',
    tokenPlaceholder: 'Paste the pairing token',
    pageSharing: 'Page content sharing',
    pageSharingHelp: 'Web page reading permission policy',
    ...
    unrestrictedBrowserAccessHelp: 'Perform actions without confirmation dialogs',
    language: 'Language',
    ...
    relayHelp: 'Custom model API relay routes',
...
const ZH: PanelCopy = {
  ...
  settings: {
    ...
    tokenHelp: '任何实例都需要配对令牌，本机同样需要',
    tokenPlaceholder: '粘贴配对令牌',
    pageSharing: '页面内容共享',
    pageSharingHelp: '助手读取网页正文策略',
    sharingAuto: '自动共享（默认）',
    sharingAsk: '每次询问',
    sharingOff: '关闭',
    unrestrictedBrowserAccess: '允许模型完全控制浏览器',
    unrestrictedBrowserAccessHelp: '无需弹窗二次确认即可操作网页与标签页',
    language: '界面语言',
    languageHelp: '侧边栏界面显示语言',
