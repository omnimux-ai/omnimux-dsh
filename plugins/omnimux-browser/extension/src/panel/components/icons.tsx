...
/**
 * The platform mark beside a page card's title.
 *
 * The card shows the platform name the page sensor reported, so the mark has to
 * come from the same place: a fixed glyph here is what made a TikTok page render
 * a Twitter logo next to the word "TikTok".
 */
