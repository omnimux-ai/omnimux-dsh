...
export declare const BROWSER_TOOL_NAMES: readonly ["browser_snapshot", "browser_click", "browser_type", "browser_press", "browser_scroll", "browser_navigate", "browser_open_tab", "browser_list_tabs", "browser_follow_tab", "browser_close_tab", "browser_back", "browser_forward", "browser_reload", "browser_get_text", "browser_wait"];
/**
