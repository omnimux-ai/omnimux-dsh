...
> **流程部分 SUPERSEDED — 2026-09-09 / #864：** 下文 L2/独立环境验收要求退役，Python 供应、签名、平台兼容与安全要求不变。当前执行顺序见 [dev-pipeline](../contracts/dev-pipeline.md) 和 [plugin-qa](../contracts/plugin-qa.md)；历史失败与未验结果不重标。
