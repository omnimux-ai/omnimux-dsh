...
/** Synthetic receipts for offline validator tests, never real IAB acceptance evidence. */
export function liveEvidence(root, evidenceDir) {
  ...
  const report = {
    ...request, pass: true, status: 'completed', tool: 'codex-iab', tabId: 'iab-tab-1', actualUrl: request.url,
